...
import openDeli from '@app/assets/icons/open-deli-logo.png';
import onboardingCar from '@app/assets/icons/illustration-car.png';
import onboardingMoped from '@app/assets/icons/illustration-moped.png';
...
export const Images = {
  ...
  OnboardingMoped: onboardingMoped,
